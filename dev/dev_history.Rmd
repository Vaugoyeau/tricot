...
ATTENTION à modifier, on doit importer une image magick et non la taille de l'image !!!!  
Faire une condition sur le type d'image !!!  
...
ggplot2::ggplot(test) + 
  ...
  ggplot2::geom_raster() + 
  ggplot2::scale_fill_manual(values = test$col) + 
  ggplot2::theme(
